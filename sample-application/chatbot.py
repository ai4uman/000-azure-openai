...
OPENAI_API_TYPE = "azure"
OPENAI_API_VERSION = "2023-05-15"
AZURE_OPENAI_API_ENDPOINT = os.getenv("OPENAI_API_BASE")
AZURE_OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")

# Create the chat llm
Settings.llm = AzureChatOpenAI(
    deployment_name="gpt-35-turbo",
    openai_api_key="a4045aa159484b9b84730e8fa5795130",
    openai_api_base="https://azure-openai-682245.openai.azure.com/",
